        ...
        <>
          ...
          currentCars.map((e) => {
            return (
                ...
                <div className={style.flexContainerPublications}>
                    ...
                    <div className={style.itemsDescriptionContainerPublications}>
                      ...
                      <div className={style.itemsContainerPublications}>
                        <h5 className={style.titulo} >Marca: <span className={style.subtitulo}>{e.brand}</span></h5>
                        <h5 className={style.titulo} >Modelo: <span className={style.subtitulo}>{e.model}</span></h5>
                        <h5 className={style.titulo} >Año: <span className={style.subtitulo}>{e.year}</span></h5>
                        <h5 className={style.titulo} >Km: <span className={style.subtitulo}>{e.km}</span></h5>
                      </div>
                      <div className={style.descriptionContainer}>
                        <h5 className={style.titulo} >descrition</h5>
                       <div className={style.decriptiontext}> <p className={style.subtitulo}>{e.description.slice(0,100)}...</p></div>
                      </div>

                    </div>{/* div de itemsDescriptionContainerPublications */}
                    <div>
                ...
                </div> {/* div de flexContainerPublication  */}
                </div>
