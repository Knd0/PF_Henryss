      ...
      <div className='w-4/12 mx-auto bg-stone-200 rounded-lg'>
        <form onSubmit={(e) => handleSubmit(e)}>
          ...
          <div className='mb-10'>
            ...
            <input onChange={(e) => handleChange(e)} value={input.nickname} type="text" name="nickname" className='block p-0 w-9/12 text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer ml-10' />
          </div>

          <div className='mb-10'>
            <h5 className='text-left pl-10 mb-1'>Nickname:</h5>
            <input onChange={(e) => handleChange(e)} value={input.name} type="text" name="name" className='block p-0 w-9/12 text-md text-gray-900 bg-transparent border-0 border-b-2 border-gray-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer ml-10' />
          </div>
