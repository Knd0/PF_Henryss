...
export default function Home() {
  ...
  const images = [PRUEBA, PRUEBA2, PRUEBA3];
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full justify-evenly max-sm:flex max-sm:content-center max-sm:flex-col max-sm:content-center sm:grid sm:grid-cols-4 lg:flex lg:justify-arround max-w-screen-lg md:mx-auto mt-10">
        <div className={style.homeFlexCardContainer}>
          <div className={style.hideButton}>
            <Card
              ...
              img={allCars[0].img.secure_url || allCars[0].img}
          ...
          <div className={style.hideButton}>
            <Card
              ...
              img={allCars[1].img.secure_url || allCars[1].img}
