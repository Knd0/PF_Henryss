...
export function ProgressBar01 () {
    
      return (
        <>
            <div className="flex justify-between mb-1">
                <span className="text-base font-medium text-blue-700 dark:text-white">Progress</span>
                <span className="text-sm font-medium text-blue-700 dark:text-white">1%</span>
            </div>
  ...
  export function ProgressBar02 () {
    
    return (
      <>
          <div className="flex justify-between mb-1">
                <span className="text-base font-medium text-blue-700 dark:text-white">Progress</span>
                <span className="text-sm font-medium text-blue-700 dark:text-white">18%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
...
export function ProgressBar03 () {
    
    return (
      <>
          <div className="flex justify-between mb-1">
                <span className="text-base font-medium text-blue-700 dark:text-white">Progress</span>
                <span className="text-sm font-medium text-blue-700 dark:text-white">36%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
...
export function ProgressBar04 () {
    
    return (
      <>
          <div className="flex justify-between mb-1">
                <span className="text-base font-medium text-blue-700 dark:text-white">Progress</span>
                <span className="text-sm font-medium text-blue-700 dark:text-white">52%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700">
