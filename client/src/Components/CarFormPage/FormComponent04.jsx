...
export function FormComponent04 (props) {
  const  { 
    ...
    return (
        <>
        <ProgressBar04/>
        <h2 className="mb-4 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-2xl mt-10 lg:text-3xl dark:text-white">Upload your car photos 📸</h2>
